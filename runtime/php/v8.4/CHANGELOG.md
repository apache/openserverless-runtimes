...
- **Performance Optimizations for PHP 8.4**
  ...
  - **Enhanced OPcache configuration**
    - Increased `max_accelerated_files` from 7,963 to 16,229 (prime number for better hash distribution)
  ...
  - **Optimized compile.php**
    - Added `--classmap-authoritative` flag to composer install for faster autoloading
...
- Optimized Dockerfile for reduced image size
  ...
  - Moved jq from PHP extension to APT package (it's not a PHP extension)
