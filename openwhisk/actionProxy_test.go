...
func TestStartLatestAction_emit1(t *testing.T) {
	...
	ap := NewActionProxy("./action/t2", "", logf, logf, false)
...
func TestStartLatestAction_terminate(t *testing.T) {
	...
	logf, _ := ioutil.TempFile("/tmp", "log")
	ap := NewActionProxy("./action/t3", "", logf, logf, false)
...
func TestStartLatestAction_emit2(t *testing.T) {
	...
	logf, _ := ioutil.TempFile("/tmp", "log")
	ap := NewActionProxy("./action/t4", "", logf, logf, false)
...
func Example_compile_bin() {
	...
	logf, _ := ioutil.TempFile("/tmp", "log")
	ap := NewActionProxy("./action/c1", "_test/compile.py", logf, logf, false)
...
func Example_compile_src() {
	...
	logf, _ := ioutil.TempFile("/tmp", "log")
	ap := NewActionProxy("./action/c2", "_test/compile.py", logf, logf, false)
...
func Example_SetEnv() {
	ap := NewActionProxy("", "", nil, nil, false)
	fmt.Println(ap.env)
